...
class RegisterUserViewController: UIViewController {
    ...
    @IBAction func signinButtonTapped(_ sender: Any) {
        ...
        /*let postString:[String:String] = ["email":emailTextField.text!,
        ...
        /*let orderData:Data? = "data".data(using: .utf8)*/
        
        /*let orderData: [String:String] = ["data":postString]*/
        
        /*request.httpBody = postString.data(using:String.e)*/
